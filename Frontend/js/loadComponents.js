...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  await loadComponent("/Frontend/components/header.html", "main-header");
  await loadComponent("/Frontend/components/footer.html", "main-footer");

  // Después de cargar el footer, inicializamos el formulario de suscripción
